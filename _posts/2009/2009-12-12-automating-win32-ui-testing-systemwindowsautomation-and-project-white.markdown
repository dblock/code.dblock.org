...
Someone must have had this problem before me. That someone is ThoughtWorks and they created [White](http://web.archive.org/web/20091128163522/http://white.codeplex.com/). White exposes a strongly typed and therefore less verbose and more usable object model for the UI being tested.
...
My original problem was [a bug in dotNetInstaller](http://web.archive.org/web/20150625113453/http://dotnetinstaller.codeplex.com/workitem/4856) where adding an installed check through the UI would popup an error. I was now able to write a unit test for it.
