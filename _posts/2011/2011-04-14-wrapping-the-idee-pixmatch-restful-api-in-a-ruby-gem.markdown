...
dblog_post_id: 198
---
I had a nice time today wrapping up the [Idee PixMatch API](http://web.archive.org/web/20110426035616/http://ideeinc.com/products/pixmatch/) in a Ruby gem. PixMatch is a general image matching engine that allows you to perform large scale image comparisons and I wanted to upload a few million images and check it out.
