...
CSS files generated by SASS and JS files generated by coffee are packaged together by [Jammit](https://web.archive.org/web/20110122180115/http://documentcloud.github.com/jammit/). The latter uses a configuration file to specify what is to be packaged and how. Here’s a simplified version of our _config/assets.yml_ _._
...
We’ve distributed our bucket on the CloudFront dashboard on Amazon and pointed our own DNS server for _static.example.com_ to _somemagicnumber.cloudfront.net_. This way I can go to _http://static.example.com/assets/common.css_ and see the _assets/common.css_ file that I have uploaded to S3.
