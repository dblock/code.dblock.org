...
Last week I wrote [an article on the Art.sy Engineering blog about testing with RSpec and Capybara](https://artsy.github.io/blog/2012/02/03/reliably-testing-asynchronous-ui-w-slash-rspec-and-capybara).
