...
We'll assume that [Spring-Security](https://web.archive.org/web/20100711232718/https://static.springsource.org/spring-security/site/) is configured via web.xml with a filter chain and a Spring _ContextLoaderListener_. The Waffle beans configuration will be added to _waffle-filter.xml_.
...
- [Spring-Security](https://web.archive.org/web/20100711232718/https://static.springsource.org/spring-security/site/)
