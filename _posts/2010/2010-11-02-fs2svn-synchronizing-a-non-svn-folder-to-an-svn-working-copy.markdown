...
We can do better. I added a new tool to the [Svn2svn project](https://github.com/dblock/svn2svn), _fs2svn_ that does just that. It uses [FolderSync](https://www.codeproject.com/Articles/7415/FolderSync-class-for-NET) with [SharpSVN](https://github.com/AmpScm/SharpSvn) and will perform the appropriate svn action for each file or directory. You can run it in simulation mode too. It won't commit anything, you can examine the results and commit them on your time.
