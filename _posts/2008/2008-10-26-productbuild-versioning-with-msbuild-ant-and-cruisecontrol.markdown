...
We use [MSBuild Community Tasks](http://web.archive.org/web/20081106105747/http://msbuildtasks.tigris.org/) to generate the version number.
...
The template replacement, task from [MSBuild Community Tasks](http://web.archive.org/web/20081106105747/http://msbuildtasks.tigris.org/).
