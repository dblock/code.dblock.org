...
- [Kaminari](https://github.com/kaminari/kaminari): Paginator for modern web app frameworks and ORMs, including Mongoid.
...
- [Mongoid::Sadstory](https://www.rubydoc.info/gems/mongoid-sadstory/0.0.2): Adds support for multiparameter fields to mongoid 4.x series.
